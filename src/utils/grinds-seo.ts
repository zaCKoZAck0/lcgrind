...
export type GrindsForumPostingInput = {
...
export type GrindsForumPostingJsonLd = {
...
export function buildGrindsForumPostingJsonLd(
    i: GrindsForumPostingInput,
): GrindsForumPostingJsonLd {
    const ld: GrindsForumPostingJsonLd = {
        "@context": "https://schema.org",
        "@type": "DiscussionForumPosting",
        headline: i.title,
        text: i.body,
