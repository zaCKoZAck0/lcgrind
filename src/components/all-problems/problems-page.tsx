...
import { TypeTabs } from "~/components/problems/type-tabs";
...
export function ProblemsPage({ initialProblems, initialProblemIds, companyOptions }: ProblemsPageProps) {
    ...
    return (<div className="w-full max-w-[1000px] py-6">
        <div className="mb-12 shadow-shadow">
            <div className='p-6 border-2 border-border bg-card flex flex-col bg-main text-main-foreground'>
        ...
        <div className="shadow-shadow">
            <Filters filters={{ sorting: sort, order, search }} companies={companies} tags={tags} difficulties={difficulties} companyOptions={companyOptions} isProblemFilter />
