...
interface RandomSheetProblemPickerProps {
    sheetSlug: string;
}

export function RandomSheetProblemPicker({
    sheetSlug,
}: RandomSheetProblemPickerProps) {
    const [isOpen, setIsOpen] = useState(false);
    const [isLoading, setIsLoading] = useState(false);
    const [problem, setProblem] = useState<SheetProblem | null>(null);
    ...
    const fetchRandomProblem = async (excludeCompleted: boolean = true) => {
        ...
        try {
            ...
            const result = await getRandomSheetProblem(
                sheetSlug,
